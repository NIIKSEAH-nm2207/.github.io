...
for (i = 0; i < 250; i++) {
    ...
    if (indivanime.studioo.includes("Topcrat")) {
    ...
    if (indivanime.studioo.includes("Whit+Fox")) {
...
numberperstudio.sort((a, b) => b - a);

const backgroundcolor = [];

for (j = 0; j < studiolist.length; j++) {
    if (numberperstudio[j] < 2 && numberperstudio[j] > 0) {
        backgroundcolor.push("rgb(0,0,0)")
    } if (numberperstudio[j] < 3 && numberperstudio[j] > 1) {
        backgroundcolor.push("rgb(0,0,38)")
    }
    if (numberperstudio[j] < 4 && numberperstudio[j] > 2) {
        backgroundcolor.push("rgb(0,0,57)")
    } if (numberperstudio[j] < 5 && numberperstudio[j] > 3) {
        backgroundcolor.push("rgb(0,0,76)")
    } if (numberperstudio[j] < 6 && numberperstudio[j] > 4) {
        backgroundcolor.push("rgb(0,0,95)")
    } if (numberperstudio[j] < 7 && numberperstudio[j] > 5) {
        backgroundcolor.push("rgb(0,0,114)")
    } if (numberperstudio[j] < 8 && numberperstudio[j] > 6) {
        backgroundcolor.push("rgb(0,0,133")
    } if (numberperstudio[j] < 9 && numberperstudio[j] > 7) {
        backgroundcolor.push("rgb(0,0,152")
    } if (numberperstudio[j] < 10 && numberperstudio[j] > 8) {
        backgroundcolor.push("rgb(0,0,171")
    }
    if (numberperstudio[j] < 11 && numberperstudio[j] > 9) {
        backgroundcolor.push("rgb(0,0,190")
    } if (numberperstudio[j] < 12 && numberperstudio[j] > 10) {
        backgroundcolor.push("rgb(0,0,209")
    }
    if (numberperstudio[j] < 13 && numberperstudio[j] > 11) {
        backgroundcolor.push("rgb(0,0,228")
    }
    if (numberperstudio[j] < 14 && numberperstudio[j] > 12) {
        backgroundcolor.push("rgb(0,0,247")
    }
    if (numberperstudio[j] < 19 && numberperstudio[j] > 17) {
...
new Chart("popularitystudio",
    {
        type: "bar",
        data: popularitystudio,
        options: {
            onHover: function (evt) { console.log("hello") },
